 ...
 * @author Senarathna
 */
public class busSearch extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Check for Bus availability");
    ...
    private void btnCheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckActionPerformed
        ...
        String checkData = MainForm.manager.searchBus(day, month, year, depAirport, arrAirport, airline);
        
        //DD::: if no Buss available, display message, else show next window
        
        if (checkData.trim()!="")
        {
            BusSearchResults select = new BusSearchResults(checkData);
        ...
        {
            JOptionPane.showMessageDialog(null, "Sorry but there are no Bus for the provided details.");
        }
